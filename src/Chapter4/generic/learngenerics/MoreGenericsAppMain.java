package Chapter4.generic.learngenerics;

import Chapter4.generic.learngenerics.ext.Children;
import Chapter4.generic.learngenerics.ext.GrandParent;
import Chapter4.generic.learngenerics.ext.Parent;
...
//        justG2Method(g3List);
        ...
        // >> TODO 那么怎么办呢？要让接收方，也就是形参，声明为 协变泛型
        extMethod(g3List);
...
//        g2ListExt = new ArrayList<GrandParent>();
        ...
        // >> TODO 但是使用这个带 协变泛型的引用，我们无法让 具体的类型满足其参数要求
...
//        g2ListExt.add(new Children());
        ...
        List<Children> g3OnluyList = new ArrayList<>();
        g2ListExt = g3OnluyList;
...
//        List<? super Parent> g2ListSup11 = new ArrayList<? super Parent>();
    ...
    private static void justG2Method(List<Parent> extParam) {
