package Lesson56_constructorMethod.supermarket;
...
public class LittleSuperMarket {
    ...
    public MerchandiseV2WithConstructor[] merchandises;
    ...
    public LittleSuperMarket(String superMarketName, String address, int parkingCount,
        ...
        merchandises = new MerchandiseV2WithConstructor[merchandiseCount];
        for (int i = 0; i < merchandises.length; i++) {
            double purchasePrice = Math.random() * 200;
            // 创建并给商品的属性赋值
            MerchandiseV2WithConstructor m = new MerchandiseV2WithConstructor(
                    "商品" + i,
                    "ID" + i,
                    count,
    ...
    public void setMerchandises(MerchandiseV2WithConstructor[] merchandises) {
    ...
    public MerchandiseV2WithConstructor getBiggestProfitMerchandise() {
        MerchandiseV2WithConstructor curr = null;
        for (int i = 0; i < merchandises.length; i++) {
            MerchandiseV2WithConstructor m = merchandises[i];
            // 这个逻辑有问题吗？相同的利润怎么判断？
     ...
     * @return
     */
    public MerchandiseV2WithConstructor getMerchandiseOf(int merchandiseIndex) {
